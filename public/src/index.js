...
import { initializeApp, getApp} from "https://www.gstatic.com/firebasejs/10.7.2/firebase-app.js";
...
// Initialize Firebase
const app = initializeApp(firebaseConfig, "MainInstance" );
            ...
            .then((res) => {
                ...
                res.items.forEach((itemRef) => {
                    itemRef.getDownloadURL().then((url) => {
                        console.log("Item referenciado: " + itemRef)
                        console.log("Link de descarga: " + url)
                    })
                });
            }).catch((error) => {
                console.log('error')
